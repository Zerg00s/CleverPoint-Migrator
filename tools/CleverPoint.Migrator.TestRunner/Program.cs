...
public static class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        var scenarios = new Dictionary<string, Func<Task>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["tax-xtenant"] = Scenarios.CrossTenantTaxonomyTest.RunAsync,
            ["tax-matrix"] = Scenarios.TaxonomyMatrixTest.RunAsync,
            ["tax-raw"] = Scenarios.TaxonomyRawFormatProbe.RunAsync,
            ["tax-api"] = Scenarios.TaxonomyApiEngineTest.RunAsync,
            ["stale-map"] = Scenarios.StaleUpsertMapTest.RunAsync,
            ["corner"] = Scenarios.LifecycleCornerCasesTest.RunAsync,
            ["date-sort"] = Scenarios.DateSortTest.RunAsync,
            ["date-locale-probe"] = Scenarios.DateLocaleProbe.RunAsync,
            ["date-locale-fix"] = Scenarios.DateLocaleFixTest.RunAsync,
            ["date-demo"] = Scenarios.DateSortDemoLib.RunAsync,
            ...
            ["throttle-unit"] = Scenarios.ThrottleTest.RunAsync,
